            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              <tr>
                <td colspan="2" bgcolor="#006699" style="color: white;">
                  <b><?php print t('Renter\'s Information:'); ?></b>
                </td>
              </tr>
              <tr>
                <td nowrap="nowrap">
                  ...
                  <table width="100%" cellspacing="0" cellpadding="0" style="font-family: verdana, arial, helvetica; font-size: small;">
                    <tr>
                      ...
                      <td valign="top" width="50%">
                        ...
                        <br />
                        <b><?php print t('Delivery Phone:'); ?></b><br />
              ...
              <tr>
                <td nowrap="nowrap">
                  <b><?php print t('Monthly Rent Rate:'); ?></b>
                </td>
                <td width="98%">
              ...
              <tr>
                <td colspan="2" bgcolor="#EEEEEE">
                  <font color="#CC6600"><b><?php print t('Delivery Details:'); ?></b></font>
                </td>
              </tr>
              <?php endif; ?>
              ...
              <tr>
                <td colspan="2">
                  ...
                  <table border="0" cellpadding="1" cellspacing="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <b><?php print t('Delivery Method:'); ?></b>
                      </td>
                      <td width="98%">
                    ...
                    <tr>
                      <td nowrap="nowrap">
                        <?php print t('Products Monthly Rent less tax:'); ?>&nbsp;
                      </td>
                      <td width="98%">
