...
function stability_webform_date($variables) {
  ...
  $element['month']['#prefix'] = '<div class = "col-xs-' . $col_size . '">';
  $element['month']['#suffix'] = '</div><div class = "col-xs-3">';
  $element['day']['#attributes']['class'][] = 'day';
  $element['day']['#suffix'] = '</div><div class = "col-xs-4">';
  $element['year']['#attributes']['class'][] = 'year';
  $element['year']['#suffix'] = '</div>';
