...
<body class="<?php print $classes; ?>" <?php print $attributes;?>>
  ...
  <div class="site-wrapper">
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
              <h1><?php print t('Furniture Rentals Inc.'); ?></h1>
    ...
    //$numby = rand($min,$max);
?>	
<div style="width:100%;text-align:center;"><? //echo $numby; ?></div>
          <div id="countdown" class="countdown text-center" ms-user-select="none" style="display:none;">
            <div class="row">
