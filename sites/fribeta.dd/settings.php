...
$databases = array (
  ...
  array (
    'default' => 
    array (
      'database' => 'furnitur_newfri',
      'username' => 'furnitur_newfri',
      'password' => '0356fr1pa55',
      'host' => 'localhost',
      'port' => '',
      'driver' => 'mysql',
      'prefix' => '',
 ...
 *
 */
$drupal_hash_salt = 'tPWkOS862-n6NiR7858RrXczGapxq5YPQza8YnK0Fpg';
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_fribeta_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_fribeta_dd.inc';
}
// </DDSETTINGS>
